...
public class MainScreen  extends Screen
{
   ...
   public void showScreen()
   {
       ...
       world.addObject(new Ball(10,1),100 ,450 );
       world.addObject(new Ball(6,2),200 ,450 );
       world.addObject(new Ball(15,3),300 ,450 );
       world.addObject(new Ball(20,4),400 ,450 );
       world.addObject(new Ball(2,5),500 ,450 );
        world.addObject(new Ball(2,5),600 ,450 );
